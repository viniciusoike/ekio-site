...
description: "O Brasil tem uma enorme população jovem que deve impulsionar sua força de trabalho nos próximos anos. Falhas na educação e o acesso desigual a oportunidades, porém, podem amortecer esse ganho: o país tem uma das maiores populações NEET do mundo."
draft: true
...
p_col <- ggplot() +
  ...
  labs(
    title = "A maior geração de jovens do Brasil: Millenials e Gen-Z",
    subtitle = str_wrap(
...
tbl_unemp <- unemp |>
  ...
  mutate(
    ...
    age_group = factor(
      age_group,
      levels = c("14-17", "18-24", "25-39", "40-59", "60+", "Overall")
    )
  ) |>
