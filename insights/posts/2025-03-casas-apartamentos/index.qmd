...
Pode-se imaginar que cidades maiores são mais verticalizadas, na média, do que cidades menores. Isto não parece ser o caso no Brasil. O gráfico abaixo mostra a relação entre o número total de domicílios e o share de apartamentos nas maiores cidades brasileiras. Consideraram-se somente cidades com pelo menos 50 mil domicílios (grosso modo, 150 mil habitantes).
