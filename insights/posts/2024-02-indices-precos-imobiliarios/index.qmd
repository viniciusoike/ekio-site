...
p_rppi_comp <- ggplot(rppi_comp, aes(date, new_index, color = source)) +
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comaparação de índices de preços imobiliários e inflação geral. Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (2019 = 100)",
...
p_rppi_brasil <- ggplot(
  ...
  labs(
    title = "Índices de Preços Imobiliários no Brasil",
    subtitle = str_wrap(
      "Comaparação de índices de preços imobiliários no Brasil. Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (jan/14 = 100)",
...
p_rppi_incc <-
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comaparação de índices de preços imobiliários e o INCC (Índice Nacional de Custos da Construção Civil). Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (jan/14 = 100)",
...
p_ivgr_ipca <- ggplot(
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comaparação de índices de preços: IVGR, INCC e IPCA. Todos índices normalizados para mar/2001.",
      111
    ),
    x = NULL,
    y = "Índice (mar/01 = 100)",
