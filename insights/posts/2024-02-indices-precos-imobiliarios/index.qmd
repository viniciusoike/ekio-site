...
description: "O Brasil tem vários índices de preços imobiliários e cada um mede uma coisa diferente. Este post apresenta os principais e explica as limitações de cada método."
...
p_rppi_comp <- ggplot(rppi_comp, aes(date, new_index, color = source)) +
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comparação de índices de preços imobiliários e inflação geral. Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (2019 = 100)",
...
p_rppi_brasil <- ggplot(
  ...
  labs(
    title = "Índices de Preços Imobiliários no Brasil",
    subtitle = str_wrap(
      "Comparação de índices de preços imobiliários no Brasil. Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (jan/14 = 100)",
...
p_rppi_incc <-
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comparação de índices de preços imobiliários e o INCC (Índice Nacional de Custos da Construção Civil). Todos índices normalizados para jan/2014.",
      111
    ),
    x = NULL,
    y = "Índice (jan/14 = 100)",
...
p_ivgr_ipca <- ggplot(
  ...
  labs(
    ...
    subtitle = str_wrap(
      "Comparação de índices de preços: IVGR, INCC e IPCA. Todos índices normalizados para mar/2001.",
      111
    ),
    x = NULL,
    y = "Índice (mar/01 = 100)",
...
plot_rppi <- function(name, start_date = NULL) {
  ...
  p_index <- ggplot(filter(rppi_sale, source == name), aes(date, index)) +
    geom_line(lwd = 0.8, color = ekio_pal("full")[[1]]) +
    geom_hline(yintercept = 100, color = ekio_pal("gray")[5], linewidth = 0.4) +
    labs(
      x = NULL,
      y = NULL,
...
Isto é outra maneira de dizer que nem todos os imóveis competem entre si. O mercado de imóveis se comporta similarmente a um *mercado de matching* onde as demandas dos clientes limitam a oferta relevante. Uma família de quatro pessoas dificilmente vai estar interessada em comprar um studio ou apartamento de 1 dormitório, qualquer que seja o seu preço. Na prática, isto significa que há vários mercados imobiliários; é possível que o mercado de casas de 4 dormitórios esteja em alta enquanto o mercado de apartamentos de 1d esteja em baixa. Similarmente, o mercado imobiliário da capital pode seguir um processo distinto do mercado imobiliário do interior.
